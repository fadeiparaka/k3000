...
async def register_start(callback: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        await callback.message.edit_text(
            ...
            "_Рега не отменяет фейсконтроль, так что принарядись и будь вежлив на входе_ 👫\n"
            "_Не регайся, если не уверен, что сможешь прийти._\n\n"
            "*Напиши свое имя и фамилию ниже одним сообщением и ты окажешься в списке на входе* 👇",
            parse_mode="Markdown"
        )
    finally:
